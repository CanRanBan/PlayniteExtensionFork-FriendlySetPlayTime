...
public class FriendlySetPlayTimePlugin : Plugin
{
    ...
    public const string Id = "CanRanBan.FriendlySetPlayTime";
    ...
    // ID for testing custom game data property from FriendlySetPlayTimeData;
    ...
    public const string TestPropertyId = "FriendlySetPlayTime.TestPropery";

    public IPluginLibraryCollection<FriendlySetPlayTimeData> DataCollection = null!;

    public FriendlySetPlayTimePlugin()
    {
        // Used only for cases where you also implement GetPluginGameDataPresenter for themes to display your data.
        // XamlId = "FriendlySetPlayTime";
    ...
    public override async Task InitializeAsync(InitializeArgs args)
    {
        ...
        DataCollection = PlayniteApi.Library.GetCustomCollection<FriendlySetPlayTimeData>(true, false);
    ...
    public override async Task<CalculateGameInstallSizeResult?> CalculateGameInstallSizeAsync(CalculateGameInstallSizeArgs args)
    {
    ...
    public override ICollection<MenuItemImpl>? GetGameMenuItems(GetGameMenuItemsArgs args)
    {
        if (args.ItemId == "game.menu.other.item.id")
        {
            ...
            var icon = UIIcon.FromFontIcon("f0668", Playnite.Fonts.NerdFont, new SolidColorBrush(Colors.DeepPink));
    ...
    public override ICollection<MenuItemDescriptor> GetAddGameMenuItemDescriptors(GetAddGameMenuItemDescriptorsArgs args)
    {
        return [];
    }
    ...
    public override ICollection<AppViewItemDescriptor>? GetAppViewItemDescriptors(GetAppViewItemDescriptorsArgs args)
    {
        ...
        [
            new AppViewItemDescriptor(
                ...
                (iconArgs) => UIIcon.FromFontIcon("f0668", Playnite.Fonts.NerdFont),
                // Icon used for when the view is activated:
                (iconArgs) => UIIcon.FromFontIcon("f0668", Playnite.Fonts.NerdFont, new SolidColorBrush(Colors.DeepPink)))
        ];
    }
    ...
    public override AppViewItem? GetAppViewItem(GetAppViewItemsArgs args)
    {
        if (args.ViewId == "test.view.id")
            return new FriendlySetPlayTimeTestAppView();
    ...
    public override async Task<GameEditSessionHandler?> GetGameEditHandlerAsync(GetGameEditHandlerArgs args)
    {
        ...
        {
            // Check FriendlySetPlayTimeGameEditSessionHandler implementation for more details.
            return new FriendlySetPlayTimeGameEditSessionHandler(args.Games[0], this);
        }
    ...
    {
        // Check FriendlySetPlayTimeSettingsHandler implementation for more details.
        return new FriendlySetPlayTimeSettingsHandler(this);
    }
    ...
    // This example provides groping based on TestProperty custom data from FriendlySetPlayTimeData.
    ...
    public override ICollection<MetadataDataSupportDescriptor> GetMetadataDataSupportDescriptors(GetMetadataDataSupportDescriptorsArgs args)
    {
        return [
    ...
    // See FriendlySetPlayTimeGameEditSessionHandler implementation for more details on that.
    ...
    private async Task DataCollectionOnCollectionChanged(DataCollectionChangeArgs<FriendlySetPlayTimeData> data, object sender, CancellationToken cancellationToken)
    {
    }
    ...
    public override async Task<MetadataProvider?> GetMetadataProviderAsync(GetMetadataProviderArgs args)
    {
        ...
        return new FriendlySetPlayTimeMetadataProvider();
    }
        ...
        if (args.Id == "sidebar.item.id")
            ...
            [
                new BasicSidebarItem(
                    UIIcon.FromFontIcon("f01e5", Playnite.Fonts.NerdFont),
    ...
    public void LocalizationExample()
    {
        ...
        // Check FriendlySetPlayTimeSettingsView.xaml to see how to use this in XAML views.
    }
