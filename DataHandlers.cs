...
public class TestPropertyGrouper : GameGrouper
{
    ...
    public TestPropertyGrouper(FriendlySetPlayTimePlugin plugin) : base([FriendlySetPlayTimePlugin.TestPropertyId])
    {
        this.plugin = plugin;
    }
...
{
    public TestPropertySorter(FriendlySetPlayTimePlugin plugin) : base([FriendlySetPlayTimePlugin.TestPropertyId])
    {
    }
...
public class TestPropertyGameFilterer : GameFilterer
{
    ...
    public TestPropertyGameFilterer(FriendlySetPlayTimePlugin plugin, Plugin.GetGameFilterersArgs args) : base(args)
    {
        this.plugin = plugin;
...
public class TestPropertyGameExplorer : GameExplorer
{
    ...
    [
        new GameExplorerItem("explorer.id.1", "True",
            ...
            new GameExplorerFilterData(FriendlySetPlayTimePlugin.TestPropertyId, true)),
        new GameExplorerItem("explorer.id.2", "False",
            new GameExplorerFilterData(FriendlySetPlayTimePlugin.TestPropertyId, false))
    ];
...
public class TestPropertyGameMetadataSessionHandler : GameMetadataSessionHandler
{
    ...
    public TestPropertyGameMetadataSessionHandler(FriendlySetPlayTimePlugin plugin)
    {
        this.plugin = plugin;
    }
    ...
    public override async Task<bool> ApplyValueAsync(ApplyValueAsyncArgs args)
    {
        ...
        if (args.Value is bool value)
        {
            ...
            if (existing is null)
            {
                var newData = new FriendlySetPlayTimeData
                {
                    Id = args.Game.Id,
                    TestProperty = value
                };
