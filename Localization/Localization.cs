...
{
    public LocalizedString() : base(FriendlySetPlayTimePlugin.Id)
    {
    }

    public LocalizedString(string stringId) : base(FriendlySetPlayTimePlugin.Id, stringId)
    {
    }
}
