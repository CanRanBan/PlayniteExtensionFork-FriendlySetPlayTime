...
public partial class FriendlySetPlayTimeData : LibraryObject
{
    ...
    public FriendlySetPlayTimeData GetCopy()
    {
        return new()
        {
            Id = Id,
...
public class FriendlySetPlayTimeGameEditSessionSection : GameEditSessionSection
{
    public FriendlySetPlayTimeGameEditSessionSection(string sectionName, FrameworkElement view) :
...
public class FriendlySetPlayTimeGameEditSessionHandler : GameEditSessionHandler
{
    private readonly Game game;
    private readonly FriendlySetPlayTimePlugin plugin;

    public FriendlySetPlayTimeData EditData { get; }

    public FriendlySetPlayTimeGameEditSessionHandler(Game game, FriendlySetPlayTimePlugin plugin)
    {
        this.game = game;
        this.plugin = plugin;
        ...
        {
            EditData = new FriendlySetPlayTimeData();
        }
    }
    ...
    {
        return [
            new FriendlySetPlayTimeGameEditSessionSection("FriendlySetPlayTime", new FriendlySetPlayTimeGameEditView
                {
