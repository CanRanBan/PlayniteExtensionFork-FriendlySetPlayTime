...
public class FriendlySetPlayTimeMetadataProviderProviderGameSession : MetadataProviderGameSession
{
    public FriendlySetPlayTimeMetadataProviderProviderGameSession(Game game) : base(game)
    {
    }
...
public class FriendlySetPlayTimeMetadataProvider : MetadataProvider
{
    public override async Task<MetadataProviderGameSession?> CreateGameSessionAsync(CreateGameMetadataSessionArgs args)
    {
        ...
        return new FriendlySetPlayTimeMetadataProviderProviderGameSession(args.Game);
    }
}